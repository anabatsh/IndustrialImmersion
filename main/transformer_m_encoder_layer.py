...
class TransformerMEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn_sandwich_layer_norm = nn.LayerNorm(self.embedding_dim, eps=1e-5, elementwise_affine=True) if self.sandwich_ln else None
        ...
        self.final_sandwich_layer_norm = nn.LayerNorm(self.embedding_dim, eps=1e-5, elementwise_affine=True) if self.sandwich_ln else None
